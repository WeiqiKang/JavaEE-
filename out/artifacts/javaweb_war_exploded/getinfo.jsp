...
<%
    //配置信息
    String url = "jdbc:mysql://59.110.11.72:3306/student?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSI=true";
...
<%
    ...
    if (username != null && password != null ) {
        User user = new User(username, password, identify, class_num);
